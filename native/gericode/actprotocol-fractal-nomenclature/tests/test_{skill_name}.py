"""Tests for actprotocol-fractal-nomenclature."""
...
class TestActprotocolFractalNomenclature:
    """Test suite for actprotocol-fractal-nomenclature."""

    def test_skill_structure_valid(self, tmp_path: Path) -> None:
        """Test skill has valid structure."""
        skill_dir = tmp_path / "actprotocol-fractal-nomenclature"
        skill_dir.mkdir()
